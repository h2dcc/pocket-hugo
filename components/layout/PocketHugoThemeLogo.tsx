  ...
  return (
    ...
    >
        ...
        <filter id="shadow" x="28" y="28" width="200" height="200" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
          <feDropShadow dx="0" dy="12" stdDeviation="14" flood-color="#2A3A58" flood-opacity="0.16"/>
        </filter>
      </defs>

      <rect x="28" y="28" width="200" height="200" rx="56" fill="url(#bg)"/>
      <circle cx="186" cy="76" r="22" fill="#FFFFFF" fill-opacity="0.34"/>

      <g filter="url(#shadow)">
        <path d="M80 66C80 59.3726 85.3726 54 92 54H164C170.627 54 176 59.3726 176 66V124H80V66Z" fill="url(#panel)"/>
        <path d="M80 92H176V176C176 185.941 167.941 194 158 194H98C88.0589 194 80 185.941 80 176V92Z" fill="#F7FAFF" fill-opacity="0.94"/>
